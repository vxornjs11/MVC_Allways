...
public class CCustomerCartListDao {
	...
	public ArrayList<CCustomerCartListDto> cartOptionList(String customerId) {
		...
		try {
			...
			String query2 = "where d.d_cakeoptionId = co.cakeoptionId and d.d_ordersId in (select ordersId from orders where o_customerId = '" + customerId + "' and ordersPoint is null and cakeoptionDeletedate is null)";
